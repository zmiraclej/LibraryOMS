...
Showbo.Msg={  
    ...
    InitMsg:function(width){  
      ...
      html='<div class="top"><div class="right"><div class="title" id="dvMsgTitle"></div></div></div>'+  
        ...
        '<div class="bottom" id="dvMsgBottom"><div class="right"><div class="ShowBo_Btn" id="dvMsgBtns"></div></div></div>';  
    ...
    createBtn:function(p,v,fn){  
        ...
        btn.type="button";  
        btn.className='ShowBo_Btn';  
        btn.value=v;  
        btn.onmouseover=function(){this.className='btnfocus';}  
        btn.onmouseout=function(){this.className='ShowBo_Btn';}  
