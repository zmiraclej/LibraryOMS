package com.flea.modules.ranking.service;
...
public interface ClicklikeService extends BaseService<Clicklike,Integer> {
	 ...
	 */
	Page<Clicklike> find(Page<Clicklike> page, List<String> list, List<String> list2);
