...
import com.flea.common.util.FreeMarkers;
...
public class Generate {
	...
	public static void main(String[] args) throws Exception {
		...
		String packageName = "com.flea";
		
		String moduleName = "common";			// 模块名，例：sys
		String subModuleName = "";				// 子模块名（可选） 
		String className = "Log";			// 类名，例：user
		String classAuthor = "bruce";		// 类作者，例：ThinkGem
		String functionName = "系统日志";			// 功能名，例：用户
		...
		// 模板文件路径
		String tplPath = StringUtils.replace(projectPath+"/src/main/java/com/flea/generate/template", "/", separator);
		...
		content = FreeMarkers.renderTemplate(template, model);
		filePath = javaPath+separator+model.get("moduleName")+separator+"dao/impl"+separator
				+StringUtils.lowerCase(subModuleName)+separator+model.get("ClassName")+"DaoImpl.java";
		writeFile(content, filePath);
		logger.info("Dao: {}", filePath);
		...
		content = FreeMarkers.renderTemplate(template, model);
		filePath = javaPath+separator+model.get("moduleName")+separator+"service/impl"+separator
		...
		content = FreeMarkers.renderTemplate(template, model);
		filePath = javaPath+separator+model.get("moduleName")+separator+"action"+separator
